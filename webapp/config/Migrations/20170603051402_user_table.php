...
class UserTable extends AbstractMigration 
{
    ...
    public function change()
    {
        ...
        lastname
        company
        title (ceo, president, etc)
        */

        $this->createNewTable('user', [

                ['name' => 'keyword', 'type' => 'string', 'def' => ['null' => false, 'limit' => 50] ],
                ['name' => 'phone', 'type' => 'string', 'def' => ['null' => false, 'limit' => 50] ],
                ['name' => 'email', 'type' => 'string', 'def' => ['null' => true, 'default' => null, 'limit' => 150] ],
                ['name' => 'firstname', 'type' => 'string', 'def' => ['null' => true, 'default' => null, 'limit' => 50] ],
                ['name' => 'lastname', 'type' => 'string', 'def' => ['null' => true, 'default' => null, 'limit' => 50] ],
                ['name' => 'title', 'type' => 'string', 'def' => ['null' => true, 'default' => null, 'limit' => 50] ],
                ['name' => 'company', 'type' => 'string', 'def' => ['null' => true, 'default' => null, 'limit' => 50] ],
                // etc
            ]);
